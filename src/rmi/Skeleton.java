...
public class Skeleton<T>
{
	...
	public static final int portNumber1 = 8081;
    ...
    {
    	//Reflection
    	//Server with thread implementation
    	//MethodInvocation 
    	if(c == null) {
    		throw new NullPointerException("Interface class is null");
    	} else if(server == null) {
    		...
    		address = new InetSocketAddress("localhost",8082);
    	} else {
	    	boolean containsRMIException = interfaceContainsRMIException(c);
	    	if(containsRMIException) {
...
//    			address = new InetSocketAddress(portNumber);
				...
				try {
					...
					address = (InetSocketAddress)(testSocket.getLocalSocketAddress());
					testSocket.close();
				} catch (IOException e) {
        	...
        	tcpServer = new TCPServer<T>(c, server, address, serverSocket, this);
